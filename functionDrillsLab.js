...
let nameGreeting1 = nameCheck("Bryan");
let nameGreeting2 = nameCheck("Steven");
let nameGreeting3 = nameCheck("DJ");

console.log(nameGreeting1);
...
console.log(bestMovie("Little Mermaid"));
...
console.log(emailCheck("    @devmountain"));
...
function buyFrogs(gold) {
  return Math.floor(gold / 3); // there will be some remaining gold if it is not enough to buy a frog at 3 gold
}

let totalFrogs = buyFrogs(33);
...
let arrayIsAscending2 = sortArray([2, 3, 5]);
